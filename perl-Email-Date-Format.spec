...
Requires: perl-Email-Date-Format-man
...
%package man
Summary: man components for the perl-Email-Date-Format package.
Group: Default

%description man
man components for the perl-Email-Date-Format package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Email/Date/Format.pm
